                ...
                <div class="container text-center my-5 pt-5 pb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center text-uppercase">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Sign up</li><br>
                        </ol>
                    </nav>
                </div>
            </div>
...
if(isset($_POST['submit']))
{
    ...
    if($college=="")
    {
        $clgerror=" * College Field Required ";
    }
    if($mobile=="")
    {
        $moberror=" * Required Field ";
    }
    if($fname!="" && $email!="" && $college!="" && $mobile!="" && $lname!="")
    {
       if($password==$conpass)
       {
        $name=$fname." ".$lname;
        $sql="INSERT INTO userlogin(name,email,college,mobile,password) VALUES ('$name','$email','$college','$mobile','$password')";
                    ...
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="password" class="form-control" name="password" placeholder="Your Surname">
                                ...
                                <div class="row g-3">
                                    ...
                                    <span style="color:red;"><?php echo $moberror; ?></span>
                                        <div class="form-floating">
                                            <input type="number" class="form-control" name="mobile" placeholder="Your contact">
                                            <label for="email">Contact</label>
                                        </div>
                                    </div>
                                    <span style="color:red;"><?php echo $clgerror; ?></span>
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                    ...
                                    <h6 class="mb-5"><a href="login.php">Already have Account?</a></h6>
                            </div>
                        </form>
                    </div>
                </div>
